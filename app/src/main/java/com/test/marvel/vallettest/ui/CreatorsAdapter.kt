...
import com.test.marvel.vallettest.models.CreatorSummary
import kotlinx.android.synthetic.main.adapter_creators.view.*

/**
 * Created by victor on 25/11/17.
 */
class CreatorsAdapter(val creatorSummary: ArrayList<CreatorSummary>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
